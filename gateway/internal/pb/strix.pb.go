...
func (CacheState) Descriptor() protoreflect.EnumDescriptor {
	return file_strix_proto_enumTypes[0].Descriptor()
}

func (CacheState) Type() protoreflect.EnumType {
	return &file_strix_proto_enumTypes[0]
}
...
func (CacheState) EnumDescriptor() ([]byte, []int) {
	return file_strix_proto_rawDescGZIP(), []int{0}
}

type CheckCacheRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Raw prompt bytes as received from the HTTP request body
	// Intentionally NOT unescaped or normalized
...
func (x *CheckCacheRequest) Reset() {
	*x = CheckCacheRequest{}
	mi := &file_strix_proto_msgTypes[0]
...
func (x *CheckCacheResponse) Reset() {
	*x = CheckCacheResponse{}
	mi := &file_strix_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CheckCacheResponse) Descriptor() ([]byte, []int) {
	return file_strix_proto_rawDescGZIP(), []int{1}
}
...
func (x *SetCacheRequest) Reset() {
	*x = SetCacheRequest{}
	mi := &file_strix_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetCacheRequest) Descriptor() ([]byte, []int) {
	return file_strix_proto_rawDescGZIP(), []int{2}
}
...
func (x *SetCacheResponse) Reset() {
	*x = SetCacheResponse{}
	mi := &file_strix_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetCacheResponse) Descriptor() ([]byte, []int) {
	return file_strix_proto_rawDescGZIP(), []int{3}
}
...
var File_strix_proto protoreflect.FileDescriptor

const file_strix_proto_rawDesc = "" +
	"\n" +
	"\vstrix.proto\x12\x05proto\"+\n" +
...
var (
	file_strix_proto_rawDescOnce sync.Once
	file_strix_proto_rawDescData []byte
)

func file_strix_proto_rawDescGZIP() []byte {
	file_strix_proto_rawDescOnce.Do(func() {
		file_strix_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_strix_proto_rawDesc), len(file_strix_proto_rawDesc)))
	})
	return file_strix_proto_rawDescData
}

var file_strix_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_strix_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_strix_proto_goTypes = []any{
...
var file_strix_proto_depIdxs = []int32{
...
func init() { file_strix_proto_init() }
func file_strix_proto_init() {
	if File_strix_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_strix_proto_rawDesc), len(file_strix_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_strix_proto_goTypes,
		DependencyIndexes: file_strix_proto_depIdxs,
		EnumInfos:         file_strix_proto_enumTypes,
		MessageInfos:      file_strix_proto_msgTypes,
	}.Build()
	File_strix_proto = out.File
	file_strix_proto_goTypes = nil
	file_strix_proto_depIdxs = nil
}
