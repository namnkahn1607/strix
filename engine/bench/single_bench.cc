...
inline void CurseYouClangdYouIgnoreUsedVariablesInAssertions(
...
void SanityCheck() {
    ...
    CurseYouClangdYouIgnoreUsedVariablesInAssertions(v2);
    CurseYouClangdYouIgnoreUsedVariablesInAssertions(v3);
