...
//
// Does NOT verify whether the pipeline produces semantically correct embeddings
// not. Instead they verify 2 properties must held regardless of model weights:
...
// Computes dot product between 2 vectors. Expects normalized(s).
